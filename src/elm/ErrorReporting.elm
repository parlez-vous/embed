module ErrorReporting exposing (reporterFactory, ReporterClient)
...
type alias HttpResponseOutcome = Result Http.Error ()

type alias Tagger msg = HttpResponseOutcome -> msg
...
type alias ReportInvalidTimeStamps msg = Posix -> Posix -> Cmd msg
